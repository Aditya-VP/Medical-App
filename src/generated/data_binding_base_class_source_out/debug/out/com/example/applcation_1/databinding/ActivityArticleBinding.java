...
public final class ActivityArticleBinding implements ViewBinding {
  ...
  private ActivityArticleBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvArticles) {
  ...
  public static ActivityArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityArticleBinding((LinearLayout) rootView, rvArticles);
    }
